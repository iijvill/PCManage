...
@section('content')
        ...
        <div class="uk-child-width-expand uk-flex uk-flex-center" uk-grid>
            <div class="uk-margin-large-left uk-margin-large-right uk-width-1-2">
                <div class="uk-card uk-card-default uk-card-body uk-box-shadow-large">
                    <form class="uk-form-horizontal uk-margin-small" id="form_edit" action="/employee/add" method="POST">
                        @csrf
                        @if ($errors->any())
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            submitAlert({form_id:'form_edit', dialog_title:'社員情報を登録します', dialog_text:'よろしいですか？', dialog_finish_title:'社員情報を登録しました', redirect_flg: true, redirect_url:'/employee'});
        });
    </script>
@endsection